...
CLASS lcl_smd_window DEFINITION DEFERRED.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS:
      ...
      open_int_table IMPORTING it_tab    TYPE ANY TABLE OPTIONAL
                               ...
                               i_name    TYPE string
                               io_window TYPE REF TO lcl_smd_window.
...
CLASS lcl_debugger_base DEFINITION ABSTRACT INHERITING FROM cl_tpda_script_class_super.
  ...
  PUBLIC SECTION.
    ...
    DATA: mt_obj            TYPE TABLE OF t_obj,
          ...
          mo_window         TYPE REF TO lcl_smd_window,
...
CLASS lcl_smd_window DEFINITION INHERITING FROM zcl_smd_popup .
...
CLASS lcl_smd_window IMPLEMENTATION.
...
CLASS lcl_source_parser IMPLEMENTATION.
  ...
  METHOD parse_tokens.
    ...
    DATA: lr_scan         TYPE REF TO cl_ci_scan,
          ...
          token           TYPE lcl_smd_window=>ts_kword,
          calculated_var  TYPE lcl_smd_window=>calculated_var,
          composed_var    TYPE lcl_smd_window=>composed_vars,
          tokens          TYPE lcl_smd_window=>tt_kword,
          calculated_vars TYPE  lcl_smd_window=>tt_calculated,
          composed        TYPE lcl_smd_window=>tt_composed,
          call            TYPE lcl_smd_window=>ts_calls,
          call_line       TYPE lcl_smd_window=>ts_calls_line,
          int_table       TYPE lcl_smd_window=>ts_int_tabs,
          int_tables      TYPE lcl_smd_window=>tt_tabs,
          eventtype       TYPE string,
          eventname       TYPE string,
          param           TYPE lcl_smd_window=>ts_params,
          par             TYPE char1,
          type            TYPE char1,
          class           TYPE xfeld,
          cl_name         TYPE string,
